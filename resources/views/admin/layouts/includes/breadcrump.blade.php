...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="d-flex align-items-center py-3 py-md-1">
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                    ...
                                    data-dropdown-parent="#kt_menu_685c3277a201e" data-allow-clear="true">
                                    <option></option>
            ...
            <!--end::Wrapper-->
            <!--begin::Button-->
            <a href="#" data-bs-theme="light" class="btn bg-body btn-active-color-primary" data-bs-toggle="modal"
