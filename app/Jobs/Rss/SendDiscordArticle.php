...
class SendDiscordArticle implements ShouldQueue
{
    ...
    {
        if ($this->article->data["warcaster_tag"] == "miniature-of-the-month" || $this->article->data["warcaster_tag"] == "coin-of-the-month") {
            $source_name = "";
            if ($this->article->data["warcaster_tag"] == "miniature-of-the-month") {
                $icon = "⚔️";
                $source_name .= "La miniature du mois est là !";
            } elseif ($this->article->data["warcaster_tag"] == "coin-of-the-month") {
                $icon = "🪙";
                $source_name .= "La pièce du mois est là !";
            }
