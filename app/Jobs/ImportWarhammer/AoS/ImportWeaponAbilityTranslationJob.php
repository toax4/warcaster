...
use App\Models\WeaponAbilityTranslation;
...
class ImportWeaponAbilityTranslationJob extends AoSImportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        WeaponAbilityTranslation::updateOrCreate(
            [
                'weapon_ability_id' => $ability->id,
                'lang_id' => $this->langId,
            ],
            $this->data
        );
